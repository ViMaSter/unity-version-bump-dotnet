...
namespace UnityVersionBump.Core.Tests.UnitTests.PullRequestManager.CreatePullRequestIfTargetVersionNewer.CreatePullRequestIfTargetVersionNewer;
...
class NoExistingPRs
{
    ...
    public void Setup()
    {
        ...
        mockedHTTPClient = new HttpClient(new LocalFileMessageHandler("UnitTests.PullRequestManager.Resources.NoExistingPRs")).SetupGitHub(repositoryInfo, commitInfo);
    }
