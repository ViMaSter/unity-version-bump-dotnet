...
class Edgecases
{
    ...
    {
        var mockedHTTPClient = new HttpClient(new LocalFileMessageHandler("UnitTests.PullRequestManager.Resources.NoExistingPRs")).SetupGitHub(_repositoryInfo, _commitInfo);
    ...
    {
        var mockedHTTPClient = new HttpClient(new LocalFileMessageHandler("UnitTests.PullRequestManager.Resources.TwoPagesOfPRs")).SetupGitHub(_repositoryInfo, _commitInfo);
    ...
    {
        var mockedHTTPClient = new HttpClient(new LocalFileMessageHandler("UnitTests.PullRequestManager.Resources.TwoOpenPRs")).SetupGitHub(_repositoryInfo, _commitInfo);
