...
namespace UnityVersionBump.Core.Tests.UnitTests.Editor_PullPackage_PullRequestManagerRequestManager.CreatePullRequestIfTargetVersionNewer.CreatePullRequestIfTargetVersionNewer;
...
class NoExistingPRs
{
    ...
    public NoExistingPRs()
    {
        ...
        mockedHTTPClient = new HttpClient(new LocalFileMessageHandler("UnitTests.Editor_PullRequestManager.Resources.NoExistingPRs")).SetupGitHub(repositoryInfo, commitInfo);
    }
