...
namespace UnityVersionBump.Core.Tests.UnitTests.Package_PullRequestManager.CreatePullRequestIfTargetVersionNewer;
...
class ExistingOutdatedPRs
{
    ...
    public ExistingOutdatedPRs()
    {
        ...
        mockedHTTPClient = new HttpClient(new LocalFileMessageHandler("UnitTests.Editor_PullRequestManager.Resources.ExistingOutdatedVersion")).SetupGitHub(repositoryInfo, commitInfo);
    }
