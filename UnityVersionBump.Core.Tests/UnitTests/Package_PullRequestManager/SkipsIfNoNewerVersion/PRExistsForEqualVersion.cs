...
namespace UnityVersionBump.Core.Tests.UnitTests.Package_PullRequestManager.SkipsIfNoNewerVersion;
...
class PRExistsForEqualVersion
{
    ...
    public PRExistsForEqualVersion()
    {
        ...
        mockedHTTPClient = new HttpClient(new LocalFileMessageHandler("UnitTests.Editor_PullRequestManager.Resources.ExistingEqualVersionStable")).SetupGitHub(repositoryInfo, commitInfo);
    }
    ...
    {
        var alphaHTTPClient = new HttpClient(new LocalFileMessageHandler("UnitTests.Editor_PullRequestManager.Resources.ExistingEqualVersionAlpha")).SetupGitHub(repositoryInfo, commitInfo);
