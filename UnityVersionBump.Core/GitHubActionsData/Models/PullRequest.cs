...
namespace UnityVersionBump.Core.GitHubActionsData.Models
{
    public class PullRequest
    {
        ...
        public Requested_Teams[] requested_teams { get; set; }
    ...
    public class Repo
    {
        ...
        public long subscribers_count { get; set; }
        public long network_count { get; set; }
